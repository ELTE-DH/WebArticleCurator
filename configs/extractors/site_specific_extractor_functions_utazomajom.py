...
def extract_next_page_url_test(filename, test_logger):
    ...
    assert extract_next_page_url_utazomajom(text) == 'https://utazomajom.hu/kategoria/elmenybeszamolok/page/2/?q=%2Fkategoria%2Felmenybeszamolok%2F'
